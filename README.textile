...
* Verify that a property can be read/written from/to a specific class with a specific return/parameter type
* Verify that a property is read-/write-only
